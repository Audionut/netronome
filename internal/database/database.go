...
type Service interface {
	...
	// Bufferbloat operations
	SaveBufferbloatTest(ctx context.Context, result types.BufferbloatResult) (*types.BufferbloatResult, error)
	GetBufferbloatTests(ctx context.Context, timeRange string, page int, limit int) (*types.PaginatedBufferbloatTests, error)
